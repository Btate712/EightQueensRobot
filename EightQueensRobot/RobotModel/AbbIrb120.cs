...
public static class AbbIrb120
{
    ...
    private const float Axis1MinAngle = -2.87979f;
    private const float Axis1MaxAngle = 2.87979f;
    private const float Axis2MinAngle = -1.91986f;
    private const float Axis2MaxAngle = 1.91986f;
    private const float Axis3MinAngle = -1.91986f;
    private const float Axis3MaxAngle = 1.22173f;
    private const float Axis4MinAngle = -2.79253f;
    private const float Axis4MaxAngle = 2.79253f;
    private const float Axis5MinAngle = -2.09439f;
    private const float Axis5MaxAngle = 2.09439f;
    private const float Axis6MinAngle = -6.98132f;
    private const float Axis6MaxAngle = 6.98132f;
